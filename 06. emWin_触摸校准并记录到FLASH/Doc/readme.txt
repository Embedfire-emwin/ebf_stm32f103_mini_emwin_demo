...
【*】 程序简介 
-工程名称：emWin_touch_calculate_FLASH
...
【 ！】实验操作：
连接好配套的3.2_2.8寸液晶屏，下载程序后复位开发板，按提示点击校准的圆圈即可

本程序会把触摸数据写入到外部 SPI FLASH中记录起来

【*】注意事项：
-触摸驱动移植时，主要是修改增加GUI_X_Touch_Analog文件中的GUI_TOUCH_X_MeasureX/Y函数

-在systick的中断服务函数中需要增加对库函数GUI_TOUCH_Exec的调用
