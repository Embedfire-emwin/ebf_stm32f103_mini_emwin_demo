...
【 ！】功能简介：
把FatFs文件系统使用的cc936.c文件替换为firecc936.c文件，
把unicode转换CC936的编码表存储在外部SPI FLASH中
转移后能节省大量的STM32程序空间
...
-当文件系统使用中文长文件名时会使用到转换表，
 这时应确保SPI FLASH的控制引脚已进行初始化

-Unicode编码转CC936编码表的起始地址：466*4096
