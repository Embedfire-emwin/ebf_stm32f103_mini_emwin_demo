...
static void LcdWriteReg(U16 Data) {
  // ... TBD by user
		ILI9341_Write_Cmd(Data);								//modify by fire
...
static void LcdWriteData(U16 Data) {
  // ... TBD by user
	ILI9341_Write_Data(Data);								//modify by fire
...
static void LcdWriteDataMultiple(U16 * pData, int NumItems) {
  while (NumItems--) {
    // ... TBD by user
		ILI9341_Write_Data(*pData++);						//modify by fire
...
static void LcdReadDataMultiple(U16 * pData, int NumItems) {
  while (NumItems--) {
    // ... TBD by user
		*pData++ = ILI9341_Read_Data();					//modify by fire
